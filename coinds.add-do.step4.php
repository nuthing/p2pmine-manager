...
if (!$ssh->login('root', $key)) {
  ...
  if($coindinfo['name']=="vertcoin" || $coindinfo['name']=="caishen"){ //libdb mod
  ...
  if($coindinfo['name']=="dogecoin"){ //libdb mod
...
<input type=submit value="[Step 5]> Save to Database" onclick="this.value = \"Please wait...\"; this.disabled = true"/>
</form>';
ob_flush();
flush();
ob_end_flush();
